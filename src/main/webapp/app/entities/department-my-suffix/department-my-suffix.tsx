...
import { getSearchEntities, getEntities } from './department-my-suffix.reducer';
...
export interface IDepartmentMySuffixState {
  search: string;
}

export class DepartmentMySuffix extends React.Component<IDepartmentMySuffixProps, IDepartmentMySuffixState> {
  state: IDepartmentMySuffixState = {
    search: ''
  };
