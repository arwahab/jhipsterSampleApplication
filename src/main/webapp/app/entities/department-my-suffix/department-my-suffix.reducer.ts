...
const apiSearchUrl = SERVER_API_URL + '/api/_search/departments';

// Actions

export const getSearchEntities: ICrudSearchAction<IDepartmentMySuffix> = query => ({
  type: ACTION_TYPES.SEARCH_DEPARTMENTS,
  payload: axios.get<IDepartmentMySuffix>(`${apiSearchUrl}?query=` + query)
});
