...
const apiSearchUrl = SERVER_API_URL + '/api/_search/jobs';

// Actions

export const getSearchEntities: ICrudSearchAction<IJobMySuffix> = query => ({
  type: ACTION_TYPES.SEARCH_JOBS,
  payload: axios.get<IJobMySuffix>(`${apiSearchUrl}?query=` + query)
});
