...
const apiSearchUrl = SERVER_API_URL + '/api/_search/locations';

// Actions

export const getSearchEntities: ICrudSearchAction<ILocationMySuffix> = query => ({
  type: ACTION_TYPES.SEARCH_LOCATIONS,
  payload: axios.get<ILocationMySuffix>(`${apiSearchUrl}?query=` + query)
});
