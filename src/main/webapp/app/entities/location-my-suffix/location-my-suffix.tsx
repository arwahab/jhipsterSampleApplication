...
import { getSearchEntities, getEntities } from './location-my-suffix.reducer';
...
export interface ILocationMySuffixState {
  search: string;
}

export class LocationMySuffix extends React.Component<ILocationMySuffixProps, ILocationMySuffixState> {
  state: ILocationMySuffixState = {
    search: ''
  };
