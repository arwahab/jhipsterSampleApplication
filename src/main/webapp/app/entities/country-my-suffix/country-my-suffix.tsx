...
import { getSearchEntities, getEntities } from './country-my-suffix.reducer';
...
export interface ICountryMySuffixState {
  search: string;
}

export class CountryMySuffix extends React.Component<ICountryMySuffixProps, ICountryMySuffixState> {
  state: ICountryMySuffixState = {
    search: ''
  };
