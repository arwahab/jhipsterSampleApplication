...
const apiSearchUrl = SERVER_API_URL + '/api/_search/job-histories';

// Actions

export const getSearchEntities: ICrudSearchAction<IJobHistoryMySuffix> = query => ({
  type: ACTION_TYPES.SEARCH_JOBHISTORIES,
  payload: axios.get<IJobHistoryMySuffix>(`${apiSearchUrl}?query=` + query)
});
