...
import { getSearchEntities, getEntities } from './region-my-suffix.reducer';
...
export interface IRegionMySuffixState {
  search: string;
}

export class RegionMySuffix extends React.Component<IRegionMySuffixProps, IRegionMySuffixState> {
  state: IRegionMySuffixState = {
    search: ''
  };
