...
const apiSearchUrl = SERVER_API_URL + '/api/_search/tasks';

// Actions

export const getSearchEntities: ICrudSearchAction<ITaskMySuffix> = query => ({
  type: ACTION_TYPES.SEARCH_TASKS,
  payload: axios.get<ITaskMySuffix>(`${apiSearchUrl}?query=` + query)
});
